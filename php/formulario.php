...
$conn = new mysqli ($host,$dbusarname,$dbpassword,$dbname);
...
if(mysqli_connect_error()){
    ...
    $INSERT = "INSERT INTO formulario (nombre,telefono,email,ubicacion,pagaduria) values (?,?,?,?,?)";
 ...
 $stmt->bind_param( "sisss", $nombre,$telefono,$email,$ubicacion,$pagaduria);
 $stmt->execute();
